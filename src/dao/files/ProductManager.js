...
class ProductManager {
    ...
    // declarar  fuera del constructor para acceder a las mismas desde todos los métodos.
    #products;
    #lastProductId;
    path;
    ...
    // para leer el archivo en caso de ser posible y en caso contrario se crea un archivo con un array vacio en 'this.path'
    async #readFile() {
        try {
            // esperarsta sobre la existencia del archivvo en la dirección path
    ...
    async #saveFile() {
        ...
        //  espera una respuesta. Hecho esto se convierte el array en json y se guarda la información en el archivo
    ...
    async updateProduct(id, updatedProduct) {
        ...
        if (indexToUpdate !== -1) {
            ...
            // genera el producto actualizado
    ...
    async deleteProduct(id) {
        ...
        // si no existe el ID se elimina el producto con 'splice'
        if (indexToDelete !== -1) {
